...
export default function Blog0() {
    window.document.title = "SendMe | SendMe Intro";
                            ...
                            <article className="blog-details">
                                ...
                                <div className="content">
                                    <p className='paragraph'>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto dicta, accusamus cum omnis dolor beatae! Placeat error saepe temporibus suscipit reiciendis aspernatur natus, harum quis atque consequatur similique, veritatis quae.
                                    </p>
